...
make menuconfig
Add our configuration (see buildroot-config.txt)
Build
make -j$(nproc)
Flash to SD Card
...
mpg123: ~8MB
Tips
Reduce UI updates: Change render interval in main.c
Lower framebuffer resolution: Edit /boot/config.txt
Disable anti-aliasing: Modify Cairo settings
Use lower bitrate audio: For older Pi models
Advanced Features
Playlist Management
